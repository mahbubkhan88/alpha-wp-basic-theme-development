                ...
                <div class="row">
                    ...
                    <div class="row team">
                        ...
                        if ( $attachments->exist() ) {
                            while ( $attachment = $attachments->get() ) { ?>
                                <div class="col-md-4">
                                    <div class="col-md-12 single-man">
                                    <?php echo $attachments->image( 'medium' ); ?>
                                    <h4 class="text-center"><?php echo esc_html( $attachments->field( 'name' ) ); ?></h4>
                                    <p class="text-center">
                                        <?php echo esc_html( $attachments->field( 'position' ) ); ?>,
                                        <strong>
                                            <?php echo esc_html( $attachments->field( 'company' ) ); ?>
                                    ...
                                    <p class="text-center"><?php echo esc_html( $attachments->field( 'bio' ) ); ?></p>
                                    <p class="text-center"><?php echo esc_html( $attachments->field( 'email' ) ); ?></p>
